        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 font-sans text-neutral-600 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a 
                  href="https://maps.google.com/?q=Sevindik+Mahallesi+2291+Sokak+No:5A+Merkezefendi+Denizli"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-neutral-600 text-sm">
              <li>
                <Link to="/sss" className="hover:text-[#8B7355] transition-colors duration-300">
                  Sıkça Sorulan Sorular
                </Link>
              </li>
              <li>
                <Link to="/kargo-teslimat" className="hover:text-[#8B7355] transition-colors duration-300">
                  Kargo & Teslimat
                </Link>
              </li>
              <li>
                <Link to="/iade-degisim" className="hover:text-[#8B7355] transition-colors duration-300">
                  İade & Değişim
                </Link>
              </li>
              <li>
                <Link to="/toptan-siparis" className="hover:text-[#8B7355] transition-colors duration-300">
                  Toptan Sipariş
                </Link>
              </li>
              <li>
                <Link to="/iletisim" className="hover:text-[#8B7355] transition-colors duration-300">
                  İletişim
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-neutral-600 text-sm">
              <li>
                <Link to="/hakkimizda" className="hover:text-[#8B7355] transition-colors duration-300">
                  Hakkımızda
                </Link>
              </li>
              <li>
                <Link to="/gizlilik-politikasi" className="hover:text-[#8B7355] transition-colors duration-300">
                  Gizlilik Politikası
                </Link>
              </li>
              <li>
                <Link to="/kullanim-kosullari" className="hover:text-[#8B7355] transition-colors duration-300">
                  Kullanım Koşulları
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-col md:flex-row items-center gap-4">
              <p className="text-center md:text-left font-sans text-neutral-600 text-sm">
                © 2025 Ripe Home. Tüm hakları saklıdır.
              </p>
              <a 
