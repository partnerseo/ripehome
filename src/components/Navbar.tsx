          ...
          <div className="md:hidden mt-6 pt-6 border-t border-neutral-200 max-h-80 overflow-y-auto">
            <div className="flex flex-col gap-4 pb-4">
              ...
              <button 
                ...
                className="mt-4 text-center bg-gradient-to-r from-gray-900 to-gray-800 text-white px-6 py-4 rounded-xl font-medium hover:shadow-xl transition-all inline-flex items-center justify-center gap-2"
              >
